...
outcomes.repartition(1).write.parquet("s3://grp-6-proj-datalake/outcomes")
...
street.repartition(1).write.parquet("s3://grp-6-proj-datalake/street")
...
stop_n_search.repartition(1).write.parquet("s3://grp-6-proj-datalake/stop_n_search")
