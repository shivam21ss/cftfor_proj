...
df_street = spark.read.parquet("s3://grp-6-proj-datalake/street/",header=True,inferSchema=True)
...
df_outcome = spark.read.parquet("s3://grp-6-proj-datalake/outcomes/",header=True,inferSchema=True)
...
joined_df_filled.repartition(1).write.parquet('s3://grp-6-proj-datawarehouse/master')

#========================================================Stop and search====================================================

from pyspark.sql.functions import col, to_timestamp, date_format,concat,lit, to_timestamp, from_utc_timestamp,when

df =spark.read.parquet("s3://grp-6-proj-datalake/stop_n_search",header=True,inferSchema=True)
...
df.repartition(1).write.parquet("s3://grp-6-proj-datawarehouse/stop")
